...
int main()
{
   ...
   int pileSize = PILE_MIN + rand() % (PILE_MAX - PILE_MIN + 1);
    ...
    bool smart = true;      // both computer players play under smart-mode
    ...
    cout << "*        the game of Nim is a first - player - win game : )          *" << endl;
    ...
    cout << "Both PIKE and SUPER play under \"smart-move\" mode." << endl << endl;
